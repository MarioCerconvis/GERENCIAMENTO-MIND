...
class Objeto(db.Model):
    ...
    def to_dict(self, include_historico=False):
        ...
        d = {
            ...
            "solicitante": self.projeto.solicitante if self.projeto else "",
            "atividade": self.projeto.nome if self.projeto else "",
            "data_inclusao": self.projeto.data_inclusao.isoformat() if self.projeto and self.projeto.data_inclusao else "",
            "projeto_descricao": self.projeto.descricao if self.projeto else "",
            "projeto_comentario": self.projeto.comentario if self.projeto else "",
            "nome": self.nome,
            "descricao": self.descricao or "",
            "data_limite": self.data_limite.isoformat() if self.data_limite else "",
            "responsavel_id": self.responsavel_id,
